...
class BaseController extends Controller
{
    ...
    public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger)
    {
        ...
        $this->userInformation = $this->masterModel->get('user_info', 
            'user_id, username, firstname, middlename, lastname, suffix, birthdate, contact_number, barangay, role, user_photo, email, departments.dept_id, dept_name, birthdate, role', 
            ['user_id' => user_id()], 
            [
