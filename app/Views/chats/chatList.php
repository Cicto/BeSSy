...
<div class="d-flex flex-column flex-column-fluid bg-transparent">
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="row">
            <div class="col-md-5 col-lg-4 col-sm-5 col-xs-5  mb-5 ">
            ...
            <div class="col-md-7 col-lg-8 col-sm-7 col-xs-7">
                <div class="card h-100">
                    <div id = "convo-cover" class = "d-flex flex-center flex-column position-absolute h-100 w-100 bg-light-primary rounded border border-dashed border-primary" style = "z-index: 99">
                    ...
                    <div class="card-body p-5 h-lg-500px h-md-500px h-sm-500px scroll" id = "messages">
