<div id="kt_app_sidebar" class="app-sidebar flex-column bg-city-blue" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3 " id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item">
                    <a class="menu-link d-flex flex-column" href="<?= base_url()?>">
                        ...
                        <span class="menu-title text-white fw-bold fs-2">Department Services</span>
                    </a>
                </div> 
                <div class="menu-item">
                    <a class="menu-link d-flex flex-column" href="<?= base_url()?>/applications">
                        ...
                        <span class="menu-title text-white fw-bold fs-2">Applications</span>
                    </a>
                </div> 
                <div class="menu-item">
                    <a class="menu-link d-flex flex-column" href="<?= base_url()?>/chats">
                        ...
                        <span class="menu-title text-white fw-bold fs-2">Chats</span>
                    </a>
                </div>  
            </div>
        </div>
