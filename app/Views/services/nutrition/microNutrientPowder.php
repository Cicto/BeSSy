                ...
                <div class="form-container">
                    ...
                    <form class="mt-3" id="micro-nutrient-form">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select class="form-select form-control form-control-solid" <?= $is_viewing ? ($status->status == 0 ? " " : "disabled") : " " ?> aria-label="Default select example" name="gender" id="gender" data-control="select2" data-placeholder="Gender" required="" required>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" name="address" id="address" <?= $is_viewing ? ($status->status == 0 ? " " : "disabled") : " " ?> value="<?= $is_viewing ? $transaction_info->address : "" ?>" class="form-control form-control-lg form-control-solid" placeholder="Address" value="" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-4 p-2 fv-plugins-icon-container">
                                <input type="time" name="time" id="time" <?= $is_viewing ? ($status->status == 0 ? " " : "disabled") : " " ?> value="<?= $is_viewing ? $transaction_info->time : "" ?>" class="form-control form-control-lg form-control-solid" placeholder="Time" value="" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6" hidden>
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" name="services" id="services" <?= $is_viewing ? ($status->status == 0 ? " " : "disabled") : " " ?> class="form-control form-control-lg form-control-solid" value="3">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex flex-column mt-3">
                            <li class="d-flex align-items-center py-2">
                                ...
                                Records for underweight children between the ages of 6 and 59 months and for children between the ages of 6 and 23 months.
                            </li>
                        </div>
                    </div>
                </div>
