                    ...
                    <form id="mrg-c" class="mt-3">
                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        <input type="text" name="husbands_last_name" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->husbands_last_name : "" ?>" id="husbands-last-name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Husband's Last Name" value="" required>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>

                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        <input type="text" name="husbands_first_name" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->husbands_first_name : "" ?>" id="husbands-first-name" class="form-control form-control-lg form-control-solid" placeholder="Husband's First Name" value="" required>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>

                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        <input type="text" name="husbands_middle_name" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->husbands_middle_name : "" ?>" id="husbands-middle-name" class="form-control form-control-lg form-control-solid" placeholder="Husband's Middle Name" value="" required>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        <input type="text" name="wifes_last_name" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->wifes_last_name : "" ?>" id="wifes-last-name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Wife's Last Name" value="" required>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>

                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        <input type="text" name="wifes_first_name" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->wifes_first_name : "" ?>" id="wifes-first-name" class="form-control form-control-lg form-control-solid" placeholder="Wife's First Name" value="" required>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>

                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        <input type="text" name="wifes_middle_name" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->wifes_middle_name : "" ?>" id="wifes-middle-name" class="form-control form-control-lg form-control-solid" placeholder="Wife's Middle Name" value="" required>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" name="place_of_marriage" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->place_of_marriage : "" ?>" id="place-of-marriage" class="form-control form-control-lg form-control-solid" placeholder="Place of Marriage" value="" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="date" name="date_of_marriage" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->date_of_marriage : "" ?>" id="date-of-marriage" class="form-control form-control-lg form-control-solid" placeholder="Date of Marriage" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select class="form-select form-select-solid" <?= ! $is_viewing ? " " : "disabled" ?> name="requester" id="requester" data-control="select2" data-placeholder="Requester" required>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="purpose" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->purpose : "" ?>" id="purpose" class="form-control form-control-lg form-control-solid" placeholder="Purpose" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-8">
                            ...
                            <div class="col-lg-8 fv-row">
                                <textarea name="remarks" value="" <?= ! $is_viewing ? " " : "disabled" ?> id="remarks" class="form-control form-control-lg form-control-solid w-100" rows="5" placeholder="Remarks...">
                                <?= $is_viewing ? $transaction_info->remarks : "" ?>
                                </textarea>
                            </div>
                        </div>
                        <input type="number" name="service_id" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $service->service_id ?>" class="d-none"required>
    ...
    $(document).ready(function() {
        ...
        $("#mrg-c").submit(function(e) {
            ...
            confirm(
                ...
                'question',
                "<?= base_url() ?>/lcr/addMarriageCertificate",
                "POST",
                $(this).serializeArray(),
                function(response) {
