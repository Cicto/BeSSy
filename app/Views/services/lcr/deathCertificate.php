                    ...
                    <form id="dc-form" class="mt-3">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" name="place_of_death" value="<?= $is_viewing ? $transaction_info->place_of_death : "" ?>" <?= ! $is_viewing ? " " : "disabled" ?> id="place-of-death" class="form-control form-control-lg form-control-solid" placeholder="Place of Death" value="" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="date" name="date_of_death" value="<?= $is_viewing ? $transaction_info->date_of_death : "" ?>" <?= ! $is_viewing ? " " : "disabled" ?> id="date-of-death" class="form-control form-control-lg form-control-solid" placeholder="Date of Death" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" name="requester_name" value="<?= $is_viewing ? $transaction_info->requester_name : "" ?>" <?= ! $is_viewing ? " " : "disabled" ?> id="requester-name" class="form-control form-control-lg form-control-solid" placeholder="Requester's Full Name" value="" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select class="form-select form-select-solid" name="relationship" value="<?= $is_viewing ? $transaction_info->relationship : "" ?>" <?= ! $is_viewing ? " " : "disabled" ?> id="relationship" data-control="select2" data-placeholder="Relationship to the Deceased" required>
                                    ...
                                    <option value="3" value="<?= $is_viewing ? $transaction_info->relationship : "" ?>" <?= $is_viewing && $transaction_info->relationship == "3" ? 'selected' : '' ?>>Sons/Daughters</option>
                                </select>
