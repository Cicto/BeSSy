                ...
                <div class="form-container">
                    ...
                    <form class="mt-3" id="nutrition-counseling-form">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select class="form-select form-control form-control-solid" <?= ! $is_viewing ? " " : "disabled" ?> aria-label="Default select example" name="gender" id="gender" data-control="select2" data-placeholder="Gender" required>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" name="address" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->address : "" ?>" id="address" class="form-control form-control-lg form-control-solid" placeholder="Address" value="" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                <input type="time" name="time" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->time : "" ?>" id="time" class="form-control form-control-lg form-control-solid" placeholder="Time" value="" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6" hidden>
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" <?= ! $is_viewing ? " " : "disabled" ?> name="services" id="services" class="form-control form-control-lg form-control-solid" value="2">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
