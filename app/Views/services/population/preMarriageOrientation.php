                    ...
                    <form class="mt-3" id="pre-marriage-form">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        <input type="text" name="suffix" <?= ! $is_viewing ? " " : "disabled" ?>  value="<?= $is_viewing ? $transaction_info->suffix : "" ?>" id="suffix" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Suffix" required>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="date" name="birth_date" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->birth_date : "" ?>" id="birth-date" class="form-control form-control-lg form-control-solid" placeholder="Date of Birth" required>
                            </div>
                        </div>
                        <!-- <hr> -->
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" name="age" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->age : "" ?>" id="age" class="form-control form-control-lg form-control-solid" placeholder="Age" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <!-- <hr> -->
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select class="form-select form-control form-control-solid" <?= ! $is_viewing ? " " : "disabled" ?> name="gender" id="gender" data-control="select2" data-placeholder="Select your Gender" required>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" name="country" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->country : "" ?>" id="country" class="form-control form-control-lg form-control-solid" placeholder="Country" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <!-- <hr> -->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" name="zip_code" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->zip_code : "" ?>" id="zip-code" class="form-control form-control-lg form-control-solid" placeholder="Zip Code" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        <!-- <hr> -->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-4 fv-row">
                                <input type="date" name="date" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->date : "" ?>" id="date" class="form-control form-control-lg form-control-solid" placeholder="Date" required>
                            </div>

                            <div class="col-md-4 fv-row fv-plugins-icon-container">
                                <input type="time" name="time" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->time : "" ?>" id="time" class="form-control form-control-lg form-control-solid" placeholder="Time" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6" hidden>
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input type="text" name="services" <?= ! $is_viewing ? " " : "disabled" ?> value="<?= $is_viewing ? $transaction_info->services : "" ?>" id="services" class="form-control form-control-lg form-control-solid" value="1">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                        </div>
